...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final KishVersionAccessors vaccForKishVersionAccessors = new KishVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.kish</b>
         */
        public KishVersionAccessors getKish() {
            return vaccForKishVersionAccessors;
        }
    ...
    public static class KishVersionAccessors extends VersionFactory  {

        public KishVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>kish.library</b> with value <b>0.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLibrary() { return getVersion("kish.library"); }
